  ...
  <div class="sz">
    <!-- <form class="form-horizontal"> -->
      <!-- <div class="form-group">
        <label class="col-sm-1 control-label"><label style="color: red">*</label>验证码</label>
        <div class="col-sm-3">
      ...
      <div class="form-group" style='margin-top:-15px'  >
        ...
        <div class="col-sm-3" style='font-size:12px; height:16px;line-height:18px; margin-bottom:-15px'>
          <p v-show="isSuccess">已向手机号<label style="color: red;">{{userPhone}}</label>发送验证码</p>
        </div>
      </div>
      <div class="form-group">
        <label class="col-sm-1 control-label"><label style="color: red">*</label>新密码</label>
        <div class="col-sm-3">
          <input type="password" class="formControl" id="newPass" v-model="Info.newPass" maxlength="16" placeholder="6-16位数字密码">
        </div>
      </div> -->
      <!-- <div class="form-group">
        <label class="col-sm-1 control-label"><label style="color: red">*</label>再次确认</label>
        <div class="col-sm-3">
          <input type="password" class="formControl" id="confirmNewPass" v-model="Info.confirmNewPass" maxlength="16" placeholder="6-16位数字密码">
        </div>
      </div> -->
      <!-- <div class="form-group">
    ...
    <el-row :gutter="20" >
      <el-col  :span="2" :offset="1"> <label style="color: red">*</label>验证码</el-col>
   ...
   <div class="clear"></div>
    <el-row :gutter="20">
      <el-col  :span="2" :offset="1"> <label style="color: red">*</label>新密码</el-col>
      <el-col   :span="6" >  <input type="password" class="formControl" id="newPass" v-model="Info.newPass" maxlength="16" placeholder="6-16位数字密码"> </el-col>
   </el-row>
   <div class="clear"></div>
    <el-row :gutter="20" >
      <el-col :span="2" :offset="1"> <label style="color: red">*</label>再次确认 </el-col>
      <el-col :span="6" > <input type="password" class="formControl" id="confirmNewPass" v-model="Info.confirmNewPass" maxlength="16" placeholder="6-16位数字密码"> </el-col>
   </el-row>
    <el-row :gutter="20" style='margin-top:30px;text-align:left' >
        <el-col   :span="4" :offset="3">  <el-button  type="primary" @click="modify_pass()">保存</el-button>    </el-col>
    </el-row>
    <!-- </form> -->
  </div>
</template>
