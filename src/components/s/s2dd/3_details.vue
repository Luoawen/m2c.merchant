    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="售后单详情" name="first">
        <div class="customerdetail_container">
          ...
          <div class="detail_tit03" v-show="orderDetail.status==9 && (orderDetail.orderType==1||orderDetail.orderType==2)">第三方支付平台正在处理退款</div>
      ...
      <el-tab-pane label="售后物流" name="second">
        <div class="logistics" style="padding-bottom:20px"  >
          ...
          <h3  class="building" v-if="orderDetail.status <=4">暂无物流信息<br />
            <el-button class='w100' type="primary" @click="addLogistics" v-if="logistics.status===4&&orderDetail.orderType!=2">添加物流信息</el-button>
          </h3>
