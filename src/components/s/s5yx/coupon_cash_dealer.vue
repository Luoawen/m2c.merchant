      ...
      <el-col :span="24" class="toolbar">
        <el-form :inline="true" class="demo-form-inline">
          ...
          <div class="BasicinFormation clear">
            ...
            <div class="mt10">
              ...
              <el-form-item label="面值" class="ml64">
                <el-input  v-model="couponParams.coupon_json.money" placeholder="最大1000" :maxlength="4" @change="formValidator(4)">
            ...
            <div class="pl28">
              ...
              <el-form-item label="发行量" class="ml50">
                <el-input  v-model="couponParams.total_num" :maxlength="5"  placeholder="最大99999" @change="formValidator(2)">
            ...
            <div class="tit01" v-if="couponParams.threshold_type == 1 || couponParams.threshold_type == 2">
              ...
              <el-form-item>
                <el-input  v-if="couponParams.threshold_type == 1" v-model="couponParams.coupon_json.threshold" placeholder="最大9999" :maxlength="4" @change="formValidator(9)">
                  ...
                  <el-input v-if="couponParams.threshold_type == 2"  v-model="couponParams.coupon_json.threshold" placeholder="最高100" :maxlength="3" @change="formValidator(9)">
        ...
        <el-dialog title="排除商品或店铺" :visible.sync="rangeDialogVisible" width="980px" center  :modal-append-to-body="false"  :close-on-click-modal="false"	>
          <span slot="title" class="Full-court-title">
            ...
            <span class="fr c_yx">
  					  已排除 <span class="bluecolor02">{{removeGoodsList.length}}</span> 个商品，
  				  </span>
          </span>
          <!--商品-->
