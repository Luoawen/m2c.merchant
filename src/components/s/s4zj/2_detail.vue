      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope"><span v-if="scope.row.businessType != 5 && scope.row.businessType != 6 && scope.row.businessType != 7 ">{{scope.row.businessId}}</span><span v-if="scope.row.businessType == 5 || scope.row.businessType == 6 || scope.row.businessType == 7">售后单号：&nbsp{{scope.row.businessId}}</span><br/>
            <span v-if="scope.row.businessType == 5 || scope.row.businessType == 6 || scope.row.businessType == 7"  style="font-size:12px;color: lightsteelblue ">{{scope.row.correlationBusinessId}}</span></template>
        </el-table-column>
        <el-table-column
          label="业务类型"
        ...
        <el-table-column
          label="收入/元"
          show-overflow-tooltip>
          <template slot-scope="scope"><span>+{{scope.row.inoutType == 1 ?(scope.row.amount):(1-1).toFixed(4)}}</span></template>
        </el-table-column>
        <el-table-column
          label="支出/元"
          show-overflow-tooltip>
          <template slot-scope="scope"><span v-if="scope.row.amount>=0">-{{scope.row.inoutType == 2 ?(scope.row.amount):(1-1).toFixed(4)}}</span> <span v-if="scope.row.amount <0">{{scope.row.inoutType == 2 ?(scope.row.amount):(1-1).toFixed(4)}}</span></template>
        </el-table-column>
        <!--<el-table-column
          label="商家信息"
          show-overflow-tooltip>
